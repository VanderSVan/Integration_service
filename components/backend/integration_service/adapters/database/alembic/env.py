...
from integration_service.adapters.database.settings import Settings
from integration_service.adapters.database.tables import metadata
...
def run_migrations_online():
    ...
    url = Settings().DATABASE_URL_FOR_ALEMBIC
